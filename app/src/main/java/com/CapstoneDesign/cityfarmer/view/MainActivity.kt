...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //작물 추천 알고리즘에서 유저가 선택한 답변을 저장하기 위한 배열 초기화
